  ...
  data: [
    {
      ...
      long_desc: "This game was created as a creative project for my master’s degree. It features X trying to navigate going to the grocery store and struggling with their ADHD and self-isolating tendancies.",
      process: "This game was designed using research on loneliness from the BBC Loneliness Experiment, personal experience, and human-computer interaction theories to inspire the mechanics and obstacles. This along with other research into mental health depictions in video games acted as the foundational research for the game’s accompanying 25-page research paper.\n\nThe UX testing method of A/B testing was used to provide guidance on the character design. This A/B testing helped determine color palette options and gauge how participants interpreted the TV-headed protagonist’s race and gender presentation. \n\nIterative playtesting was also conducted.",
      contribution: "All research, art assets, writing, and programming were created by me.",
      image: "assets/gr_jlout.png",
      imgdesc0: "X outside of the Jumping Lizard, the venue their friend is performing at.",
      imagealt1:"assets/gr_gh.png",
      imgdesc1: "X's first encounter on their journey. Ghoulia asks for help with her 'cat'.",
      imagealt2:"assets/gr_rt1.png",
      imgdesc2: "Retuning minigame that is triggered when X is faced with a distraction. ",
      emoji: "📺",
    },
    {
    ...
    },
    {
      ...
      contribution: "A teammate and I conducted the A/B usability testing on Ball State University’s campus. I also acted as the primary interaction designer and a lead UI designer of this wireframe in Figma.",
    ...
    {
      projectName: "Combatting Stigma: Media Redesign",
      category: "UX/UI",
      year: "2020",
      role: "UX Researcher",
      tools: "Figma, Canva, Googles Slides, & Google Forms",
      link: "https://drive.google.com/drive/folders/1SMfe_KvjWau2HlVgnEdsobynqFJONioJ?usp=sharing",
      description: "A UX project to help the Indiana Center for Prevention of Youth Abuse & Suicide",
      long_desc: "Combatting Stigma is a social media project aimed at promoting healthy conversation about and providing information about mental health. We created a guide and set of post templates for the Indiana Center for Prevention of Youth Abuse & Suicide (ICPYAS).",
      process: "Iterative designing was the key to this project. Low-fidelity prototypes were created using empathy research. These were then refined into mid-fidelity prototypes based on data from an interaction survey, user interview, co-creation session. Finally, the posts, guidelines, and style was developed into high-fidelity prototypes using A/B testing and user interviews. ",
      contribution: "I worked on all aspects of this project, however my focus area was research. Designing, conducting, and monitoring the results from A/B testing and surveys was my primary responsibility on this project. In addition, I participated in the preliminary empathy research and design thinking ideation sessions and aided in designing some of the prototypes.",
      image: "assets/icpyas_post2.png",
      imgdesc0: "A portion of a prototype post focusing on promoting a workshop.",
      imagealt1:"assets/icpyas_post4.png",
      imgdesc1: "A prototype post designed for stories focusing on positive messaging.",
      imagealt2:"assets/icpyas_post5.png",
      imgdesc2: "A prototype post designed for Twitter focusing on statistics.",
      emoji: "💙",
    },
    {
    ...
    /*
      ...
      process: "We were tasked with exploring the aesthetics of an animation and emulating an element of its style in an animation through After Effects. I chose the animation technique of Unmoving Plaid (AKA perspective incorrect texturing), which is used in the cartoon Chowder! You can see this in the static patterns on both X’s monitor and sweatshirt. This effect was achieved through Keying in After Effects, the same technique used for green screens.",
